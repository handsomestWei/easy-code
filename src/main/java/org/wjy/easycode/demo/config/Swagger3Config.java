...
public class Swagger3Config {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Swagger3接口文档").description("如有疑问，请联系xxx")
            .contact(new Contact("wjy", "https://xxx", "xxx@qq.com")).version("1.0").build();
    }
    ...
    private List<RequestParameter> getGlobalRequestParameters() {
        ...
        parameters.add(
            new RequestParameterBuilder().name("version").description("客户端的版本号").required(true).in(ParameterType.QUERY)
