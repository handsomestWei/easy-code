...
/**
 * 使用@EnableScheduling声明启用springboot定时任务。如果不配置，默认单线程顺序执行所有定时任务 使用@EnableAsync声明启用springboot自带的异步线程池
 * 
 * @see org.wjy.easycode.demo.config.ScheduleConfig
 * @see org.wjy.easycode.demo.config.ControlSchedulingConfiguration
 */
@Service
